...
namespace Drupal\drupalet_hook_node_settings;
...
class TwigExtension extends AbstractExtension {
  ...
  public function getFunctions() {
    return [
      new TwigFunction('drpn_drupal_view', 'views_embed_view'),
      new TwigFunction('drpn_drupal_block', [$this, 'drupalBlock']),
      new TwigFunction('drpn_drupal_token', [$this, 'drupalToken']),
      new TwigFunction('drpn_drupal_entity', [$this, 'drupalEntity']),
      new TwigFunction('drpn_drupal_field', [$this, 'drupalField']),
      new TwigFunction('drpn_drupal_menu', [$this, 'drupalMenu']),
      new TwigFunction('drpn_drupal_config', [$this, 'drupalConfig']),
      new TwigFunction('drpn_theme_setting', [$this, 'themeSetting']),
    ];
  }
